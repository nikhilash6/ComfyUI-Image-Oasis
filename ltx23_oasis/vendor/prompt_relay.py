# Vendored from WhatDreamsCost-ComfyUI (LTX Director) — GPL-3.0-or-later.
# Source: prompt_relay.py — temporal multi-prompt via cross-attention penalty masks.
# Modifications: none (verbatim vendor).
import logging
import math
import torch
